...
namespace Car_Rental_Management_System.Forms
{
    public partial class VehiclesForm : Form
    {
        ...
        private void WireEvents()
        {
            ...
            btnEdit.Click += (s, e) =>
            {
                if (dgvVehicles.SelectedRows.Count == 0) { MessageBox.Show("Select a row first."); return; }
            ...
            btnDelete.Click += (s, e) =>
            {
                ...
                if (MessageBox.Show($"Delete ID {id}?", "Confirm", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    dgvVehicles.Rows.RemoveAt(dgvVehicles.SelectedRows[0].Index);
                }
            };
        }
        ...
        private void VehiclesForm_Load_1(object sender, EventArgs e)
        {
