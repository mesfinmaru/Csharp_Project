namespace Car_Rental_Management_System.Forms
{
    partial class AddVehicle
    {
        ...
        private void InitializeComponent()
        {
            ...
            nurSeats.Maximum = new decimal(new int[] { 20, 0, 0, 0 });
            nurSeats.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            ...
            nurDailyRate.Maximum = new decimal(new int[] { 1000, 0, 0, 0 });
            ...
            nurWeeklyRate.Maximum = new decimal(new int[] { 10000, 0, 0, 0 });
            ...
            nurMonthlyRate.Maximum = new decimal(new int[] { 100000, 0, 0, 0 });
            ...
            nurYear.Maximum = new decimal(new int[] { 3000, 0, 0, 0 });
            nurYear.Minimum = new decimal(new int[] { 2000, 0, 0, 0 });
            nurYear.Name = "nurYear";
            nurYear.Size = new Size(237, 39);
            nurYear.TabIndex = 39;
            nurYear.Value = new decimal(new int[] { 2000, 0, 0, 0 });
            // 
            // cmbVehicleType
            // 
            ...
            btnSave.Location = new Point(601, 29);
            ...
            btnCancel.Location = new Point(265, 29);
            ...
            lblHeader.Size = new Size(246, 37);
            lblHeader.TabIndex = 0;
            lblHeader.Text = "Add New Vehicle";
